...
describe('Verify that user can search by Location', () => {
    ...
    beforeEach("Log in", function () {
        ...
        cy.get('input#location-button').should('exist')
    })
    ...
    it('Filter Australia', function() {
        ...
        cy.get('a > span.mui-11oee64').contains('Appeal to educate and empower Aussie kids').should('exist')
    })
    ...
    it('Filter Canada', function() {
        ...
        cy.wait(3000)
         ...
         cy.get('a > span.mui-11oee64').contains('Volunteer to grow native forests and climate hope - April 22 v2').should('exist')
    })
    ...
    it('Filter Germany', function() {
        ...
        cy.wait(3000)
         ...
         /***************Verification****************/
         cy.url().should('include', 'eventType=volunteering')
         cy.url().should('include', 'country=DE')
         cy.get('li.splide__slide > div > span').contains('Advocacy').should('exist')
         cy.get('li.splide__slide > div > span').contains('Animals').should('exist')
         cy.get('li.splide__slide > div > span').contains('Children').should('exist')
         cy.get('li.splide__slide > div > span').contains('Disabilities').should('exist')
    ...
    it('Filter United Kingdom', function() {
        ...
        cy.wait(3000)
         ...
         /***************Verification****************/
         cy.url().should('include', 'eventType=volunteering')
         cy.url().should('include', 'country=GB')
         cy.get('li.splide__slide > div > span').contains('Advocacy').should('exist')
         cy.get('li.splide__slide > div > span').contains('Animals').should('exist')
         cy.get('li.splide__slide > div > span').contains('Children').should('exist')
         cy.get('li.splide__slide > div > span').contains('Disabilities').should('exist')
    ...
    it('Filter Hong Kong SAR China', function() {
        ...
        cy.wait(3000)
         ...
         /***************Verification****************/
         cy.url().should('include', 'eventType=volunteering')
         cy.url().should('include', 'country=HK')
         cy.get('li.splide__slide > div > span').contains('Advocacy').should('exist')
         cy.get('li.splide__slide > div > span').contains('Animals').should('exist')
         cy.get('li.splide__slide > div > span').contains('Children').should('exist')
         cy.get('li.splide__slide > div > span').contains('Disabilities').should('exist')
    ...
    it('Filter New Zealand', function() {
        ...
        cy.wait(3000)
         ...
         /***************Verification****************/
         cy.url().should('include', 'eventType=volunteering')
         cy.url().should('include', 'country=NZ')
         cy.get('li.splide__slide > div > span').contains('Advocacy').should('exist')
         cy.get('li.splide__slide > div > span').contains('Animals').should('exist')
         cy.get('li.splide__slide > div > span').contains('Children').should('exist')
         cy.get('li.splide__slide > div > span').contains('Disabilities').should('exist')
    ...
    it('Filter Philippines', function() {
        ...
        cy.wait(3000)
         ...
         /* Temporary Verification - need to change once we will be able to add events*/
        cy.get('a > span.mui-11oee64').contains('Caring for the Community - PH').should('exist')
    ...
    it('Filter Singapore', function() {
        ...
        cy.wait(3000)
         ...
         /***************Verification****************/
         cy.url().should('include', 'eventType=volunteering')
         cy.url().should('include', 'country=SG')
         cy.get('li.splide__slide > div > span').contains('Advocacy').should('exist')
         cy.get('li.splide__slide > div > span').contains('Animals').should('exist')
         cy.get('li.splide__slide > div > span').contains('Children').should('exist')
         cy.get('li.splide__slide > div > span').contains('Disabilities').should('exist')
    ...
    it('Filter United States', function() {
        ...
        cy.wait(3000)
         ...
         /***************Verification****************/
         cy.url().should('include', 'eventType=volunteering')
         cy.url().should('include', 'country=US')
         cy.get('li.splide__slide > div > span').contains('Advocacy').should('exist')
         cy.get('li.splide__slide > div > span').contains('Animals').should('exist')
         cy.get('li.splide__slide > div > span').contains('Children').should('exist')
         cy.get('li.splide__slide > div > span').contains('Disabilities').should('exist')
