...
describe('Verify that user can search by Cause Area', () => {
    ...
    beforeEach("Log in", function () {
        ...
        cy.get('input#cause-area-button').should('exist')
    })
    ...
    it('Filter Animals', function() {
        ...
        cy.wait(3000)
        cy.url().should('include', 'eventType=volunteering')
        cy.url().should('include', 'cause=animals')
    ...
    it('Filter Disabilities', function() {
        ...
        cy.wait(3000)
        cy.url().should('include', 'eventType=volunteering')
        cy.url().should('include', 'cause=disabilities')
    ...
    it('Filter Homelessness', function() {
        ...
        cy.wait(5000)
        cy.url().should('include', 'eventType=volunteering')
        cy.url().should('include', 'cause=homelessness')
    ...
    it('Filter LGBTQ', function() {
        ...
        cy.wait(3000)
        cy.url().should('include', 'eventType=volunteering')
        cy.url().should('include', 'cause=LGBTQ')
